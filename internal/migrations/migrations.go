...
type migrationFunc func(*application.Odyssey, *migrationRunner) error
...
func RunMigrations(app *application.Odyssey) error {
...
func (m *migrationRunner) run(app *application.Odyssey) error {
