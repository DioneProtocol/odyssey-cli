...
import (
	application "github.com/DioneProtocol/odyssey-cli/pkg/application"
...
func (_m *ProcessChecker) IsServerProcessRunning(app *application.Odyssey) (bool, error) {
	...
	var r0 bool
	var r1 error
	if rf, ok := ret.Get(0).(func(*application.Odyssey) (bool, error)); ok {
		return rf(app)
	}
	if rf, ok := ret.Get(0).(func(*application.Odyssey) bool); ok {
		r0 = rf(app)
	} else {
		r0 = ret.Get(0).(bool)
	}

	if rf, ok := ret.Get(1).(func(*application.Odyssey) error); ok {
		r1 = rf(app)
	} else {
		r1 = ret.Error(1)
	}
