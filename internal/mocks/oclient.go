...
import (
	...
	api "github.com/DioneProtocol/odysseygo/api"
...
func (_m *OClient) AwaitTxDecided(ctx context.Context, txID ids.ID, freq time.Duration, options ...rpc.Option) (*omegavm.GetTxStatusResponse, error) {
	...
	var r0 *omegavm.GetTxStatusResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, ids.ID, time.Duration, ...rpc.Option) (*omegavm.GetTxStatusResponse, error)); ok {
		return rf(ctx, txID, freq, options...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, ids.ID, time.Duration, ...rpc.Option) *omegavm.GetTxStatusResponse); ok {
		r0 = rf(ctx, txID, freq, options...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*omegavm.GetTxStatusResponse)
		}
	}
...
func (_m *OClient) ExportDIONE(ctx context.Context, user api.UserPass, from []ids.ShortID, changeAddr ids.ShortID, to ids.ShortID, toChainIDAlias string, amount uint64, options ...rpc.Option) (ids.ID, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for ExportDIONE")
	}
...
func (_m *OClient) GetBalance(ctx context.Context, addrs []ids.ShortID, options ...rpc.Option) (*omegavm.GetBalanceResponse, error) {
	...
	var r0 *omegavm.GetBalanceResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []ids.ShortID, ...rpc.Option) (*omegavm.GetBalanceResponse, error)); ok {
		return rf(ctx, addrs, options...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []ids.ShortID, ...rpc.Option) *omegavm.GetBalanceResponse); ok {
		r0 = rf(ctx, addrs, options...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*omegavm.GetBalanceResponse)
		}
	}
...
func (_m *OClient) GetBlockchains(ctx context.Context, options ...rpc.Option) ([]omegavm.APIBlockchain, error) {
	...
	var r0 []omegavm.APIBlockchain
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, ...rpc.Option) ([]omegavm.APIBlockchain, error)); ok {
		return rf(ctx, options...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, ...rpc.Option) []omegavm.APIBlockchain); ok {
		r0 = rf(ctx, options...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]omegavm.APIBlockchain)
		}
	}
...
func (_m *OClient) GetCurrentValidators(ctx context.Context, subnetID ids.ID, nodeIDs []ids.NodeID, options ...rpc.Option) ([]omegavm.ClientPermissionlessValidator, error) {
	...
	var r0 []omegavm.ClientPermissionlessValidator
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, ids.ID, []ids.NodeID, ...rpc.Option) ([]omegavm.ClientPermissionlessValidator, error)); ok {
		return rf(ctx, subnetID, nodeIDs, options...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, ids.ID, []ids.NodeID, ...rpc.Option) []omegavm.ClientPermissionlessValidator); ok {
		r0 = rf(ctx, subnetID, nodeIDs, options...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]omegavm.ClientPermissionlessValidator)
		}
	}
...
func (_m *OClient) GetSubnets(ctx context.Context, subnetIDs []ids.ID, options ...rpc.Option) ([]omegavm.ClientSubnet, error) {
	...
	var r0 []omegavm.ClientSubnet
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []ids.ID, ...rpc.Option) ([]omegavm.ClientSubnet, error)); ok {
		return rf(ctx, subnetIDs, options...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []ids.ID, ...rpc.Option) []omegavm.ClientSubnet); ok {
		r0 = rf(ctx, subnetIDs, options...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]omegavm.ClientSubnet)
		}
	}
...
func (_m *OClient) GetTxStatus(ctx context.Context, txID ids.ID, options ...rpc.Option) (*omegavm.GetTxStatusResponse, error) {
	...
	var r0 *omegavm.GetTxStatusResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, ids.ID, ...rpc.Option) (*omegavm.GetTxStatusResponse, error)); ok {
		return rf(ctx, txID, options...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, ids.ID, ...rpc.Option) *omegavm.GetTxStatusResponse); ok {
		r0 = rf(ctx, txID, options...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*omegavm.GetTxStatusResponse)
...
func (_m *OClient) ImportDIONE(ctx context.Context, user api.UserPass, from []ids.ShortID, changeAddr ids.ShortID, to ids.ShortID, sourceChain string, options ...rpc.Option) (ids.ID, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for ImportDIONE")
	}
...
// NewOClient creates a new instance of OClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewOClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *OClient {
	mock := &OClient{}
